...
const MouseGlow = () => {
  ...
  return (
    <>
      ...
      /> */}
      <div
        className={`pointer-events-none fixed z-10 h-64 w-64 rounded-full bg-gradient-to-r from-highlight/30 to-secondary_accent/30 blur-3xl transition-opacity duration-300 ${
